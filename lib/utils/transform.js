 ...
 * @param {object} [logger] - Optional logger instance
 * @returns {{ content: Buffer|string, transformed: boolean }} Transformed content and status
 */
function applyTransforms (source, content, compiledTransforms, logger) {
  ...
  return { content: transformApplied ? transformed : content, transformed: transformApplied }
}
